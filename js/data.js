...
const assassins = [
    ...
    { name: 'Adan', file_name: 'Adan Abu Naaj.jpeg', kills: 1, alive: false },
    { name: 'Adem', file_name: 'Adem_Bizid.jpg', kills: 2, alive: true },
    { name: 'Ashley', file_name: 'Ashley_Gallitto.JPG', kills: 0, alive: false },
    { name: 'Ayman', file_name: 'Ayman_Riad.jpg', kills: 1, alive: true },
    { name: 'Felipe', file_name: 'Felipe_Caicedo.jpg', kills: 0, alive: false },
    { name: 'Felix', file_name: 'Felix_Watson.jpg', kills: 0, alive: false },
    { name: 'Firas', file_name: 'Firas_Khalifa_3.jpg', kills: 0, alive: true },
    { name: 'Gabriela', file_name: 'Gabriela.jpg', kills: 1, alive: true },
    { name: 'Hanan', file_name: 'Hanan_Habahbeh.JPG', kills: 2, alive: true },
    { name: 'Hemetrio', file_name: 'Hemetrio.jpeg', kills: 1, alive: true },
    { name: 'Ionut', file_name: 'Ionut_Stan.JPG', kills: 1, alive: false },
    { name: 'Isabella', file_name: 'Isabella_Perez.jpg', kills: 0, alive: false },
    { name: 'Issa', file_name: 'Issa.JPG', kills: 1, alive: false },
    { name: 'Jayleen', file_name: 'Jayleen_Perez.PNG', kills: 0, alive: false },
    { name: 'Joshua', file_name: 'Joshua_Isaacs.jpg', kills: 0, alive: true },
    { name: 'Kai', file_name: 'Kai_Beasley.JPG', kills: 0, alive: false },
    { name: 'Margarita', file_name: 'Margarita_Carranza.jpg', kills: 1, alive: true },
    ...
    { name: 'Ola', file_name: 'Ola_Kaminska.jpg', kills: 1, alive: false },
    { name: 'Olya', file_name: 'Olya_Volianyk.JPG', kills: 0, alive: true },
    { name: 'Paulo', file_name: 'Paulo_Silva.JPG', kills: 0, alive: false },
    { name: 'Pravalika', file_name: 'Pravalika.jpeg', kills: 1, alive: true },
    { name: 'Rafael', file_name: 'Rafael_Ribeiro.jpg', kills: 0, alive: true },
    { name: 'Saad', file_name: 'Saad_Thaher.jpg', kills: 2, alive: false },
    { name: 'Sara', file_name: 'Sara_Akasha.jpeg', kills: 0, alive: false },
