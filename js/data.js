...
const assassins = [
    { name: 'Kasra', file_name: 'Kasra_Mazaheri.png', kills: 0, alive: true },
    { name: 'Adem', file_name: 'Adem_Bizid.jpg', kills: 0, alive: true },
    { name: 'Ashley', file_name: 'Ashley_Gallitto.JPG', kills: 0, alive: true },
    { name: 'Ayman', file_name: 'Ayman_Riad Solh.jpeg', kills: 0, alive: true },
    { name: 'Felipe', file_name: 'Felipe_Caicedo.jpg', kills: 0, alive: true },
    { name: 'Felix', file_name: 'Felix_Watson.jpeg', kills: 0, alive: true },
    { name: 'Firas', file_name: 'Firas_Khalifa.jpg', kills: 0, alive: true },
    { name: 'Hanan', file_name: 'Hanan_Habahbeh.JPG', kills: 0, alive: true },
    { name: 'Ionut', file_name: 'Ionut_Stan.JPG', kills: 0, alive: true },
    { name: 'Isabella', file_name: 'Isabella_Perez.jpg', kills: 0, alive: true },
    { name: 'Jayleen', file_name: 'Jayleen_Perez.PNG', kills: 0, alive: true },
    { name: 'Joshua', file_name: 'Joshua_Isaacs.JPEG', kills: 0, alive: true },
    { name: 'Kai', file_name: 'Kai_Beasley.JPG', kills: 0, alive: true },
    { name: 'Margarita', file_name: 'Margarita_Carranza.jpg', kills: 0, alive: true },
    { name: 'Natalia', file_name: 'Natalia_Buchajska.jpg', kills: 0, alive: true },
    ...
    { name: 'Saad', file_name: 'Saad_Thaher.jpg', kills: 0, alive: true },
    { name: 'Sara', file_name: 'Sara_Ramirez.JPG', kills: 0, alive: true },
    { name: 'Sophia', file_name: 'Sophia_Humpeler.PNG', kills: 0, alive: true },
    { name: 'Tim', file_name: 'Tim_Hindges.jpg', kills: 0, alive: true },
    { name: 'Yusuf', file_name: 'Yusuf_Syed.jpg', kills: 0, alive: true },
    { name: 'Zsofia', file_name: 'Zsofia_Keresztely.jpg', kills: 0, alive: true },
];
